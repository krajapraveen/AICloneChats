    ...
    <div className="min-h-screen bg-cream">
      ...
      <div className="max-w-md mx-auto px-5 md:px-8 py-16">
        <div className="brutal-card p-8" data-testid="login-card">
          ...
          <p className="text-sm text-muted-foreground mb-7 font-medium">Talk to your AI self again.</p>
          ...
          <form onSubmit={onSubmit} className="space-y-4" data-testid="login-form">
            ...
            {(error || oauthError) && (
              <div className="bg-bubblegum border-2 border-ink rounded-xl px-4 py-2.5 text-sm font-medium" data-testid="login-error">
